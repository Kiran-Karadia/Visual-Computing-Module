...
T_d = [0.7071 0.7071 0; -0.7071 0.7071 7; 0 0 1];

% (e) Isotropic scale + rotation + translation.
T_e = [0.3536 -0.3536 2; 0.3536 0.3536 10; 0 0 1]; 

% (f) Anisotropic scale + rotation + translation.
T_f = [-0.2828 0.5657 4; -0.2828 -0.5657 14; 0 0 1];

% (g) Fully affine.
T_g = [0.9 0.4 7.9746; 0.4 0.9 8.0251; 0 0 1];

% (h) Perspective.
T_h = [0.274 -0.851 9.812; -0.229 -0.215 5.649; -0.019 -0.091 1];
